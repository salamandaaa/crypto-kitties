...
contract KittyCore is KittyMinting {
    ...
    function KittyCore() public {
        ...
        _createKitty(0, 0, 0, uint256(-1), address(uint160(0)));
    }
    ...
    function unpause() public onlyCEO whenPaused {
        require(saleAuction != address(uint160(0)));
        require(siringAuction != address(uint160(0)));
        require(geneScience != address(uint160(0)));
        require(newContractAddress == address(uint160(0)));
